...
| 2 | Server IP address identifiable | Nslookup resolved the domain to 192.232.216.13 | Provides information about the network location of the web service | 🟢 Low |
...
| 6 | Multiple live hosts visible on local network | Zenmap identified two live hosts in the example network | Unknown or unauthorized devices may potentially be present on a network | 🟡 Medium |
...
**LinkedIn:** www.linkedin.com/in/josiahayuba
